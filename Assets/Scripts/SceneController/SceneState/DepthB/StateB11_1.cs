...
public class StateB11_1 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        _depthBSceneController.SetHighlightIgnore((int)DepthB_SceneController.DepthB_Objects.OnStorage_Helmet);
        ...
        _depthBSceneController.SetHighlightIgnore((int)DepthB_SceneController.DepthB_Objects.Door_L);
        _depthBSceneController.SetHighlightIgnore((int)DepthB_SceneController.DepthB_Objects.Door_R);
        _depthBSceneController.TurnOffAllOnCharacter();
    }
...
public class StateB11_2 : Base_SceneState
{
    ...
    {
        base.OnEnter();
        _depthBSceneController.SetHighlightIgnore((int)DepthB_SceneController.DepthB_Objects.Door_L, false);
        _depthBSceneController.SetHighlightIgnore((int)DepthB_SceneController.DepthB_Objects.Door_R, false);
        _depthBSceneController.BlinkHighlight((int)DepthB_SceneController.DepthB_Objects.Door_R);
        _depthBSceneController.BlinkHighlight((int)DepthB_SceneController.DepthB_Objects.Door_L);
...
public class StateB11_3 : Base_SceneState
{
    ...
    public override void OnEnter()
    {    
        _depthBSceneController.contentController.uiChecklist.UncheckAndInitList();
        _depthBSceneController.contentController.uiChecklist.RefreshText();
        _depthBSceneController.contentController.uiChecklist.Show();
    
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_Helmet).SetActive(true);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_InsulatedGloves).SetActive(true);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_Earplugs).SetActive(true);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_Mask).SetActive(true);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_ProtectiveGoggles).SetActive(true);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_InsulatedShoes).SetActive(true);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_FlameResistantClothing).SetActive(true);
        
        
        _depthBSceneController.InitEquipmentSelectionPart();
    ...
    public override void OnExit()
    {
        _depthBSceneController.contentController.uiChecklist.UncheckAndInitList();
        _depthBSceneController.contentController.uiChecklist.RefreshText();
        _depthBSceneController.contentController.uiChecklist.Hide();
...
public class StateB11_4 : Base_SceneState
{
    ...
    public override void OnEnter()
    {      
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_Helmet).SetActive(false);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_InsulatedGloves).SetActive(false);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_Earplugs).SetActive(false);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_Mask).SetActive(false);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_ProtectiveGoggles).SetActive(false);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnStorage_InsulatedShoes).SetActive(false);
        ...
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnCharacter_FlameResistantClothing).SetActive(false);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.Character_NoFlameSuit).SetActive(true);
        base.OnEnter();
...
public class StateB11_5 : Base_SceneState
{
    ...
    { 
        base.OnEnter();
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.OnCharacter_FlameResistantClothing).SetActive(true);
        _depthBSceneController.GetObject((int)DepthB_SceneController.DepthB_Objects.Character_NoFlameSuit).SetActive(false);
        // _depthBSceneController.SetHighlightIgnore((int)DepthB_SceneController.DepthB_Objects.OnStorage_Earplugs,false);
        // _depthBSceneController.BlinkHighlight((int)DepthB_SceneController.DepthB_Objects.OnStorage_Earplugs);
