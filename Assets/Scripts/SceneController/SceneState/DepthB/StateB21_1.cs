...
public class StateB21_3 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        _depthBceneController.contentController.uiChecklist.UncheckAndInitList();
        _depthBceneController.contentController.uiChecklist.RefreshText();
        _depthBceneController.contentController.uiChecklist.Show();
    ...
    public override void OnExit()
    {
        _depthBceneController.contentController.uiChecklist.UncheckAndInitList();
        _depthBceneController.contentController.uiChecklist.RefreshText();
        _depthBceneController.contentController.uiChecklist.Hide();
        base.OnExit();
    }
}
...
public class StateB21_5 : Base_SceneState
{
    ...
    public override void OnEnter()
    {
        ...
        _depthBceneController.contentController.Refresh();
        _depthBceneController.DepthB31Init();    
        base.OnEnter();
